...
#include <stdlib.h>
#include <time.h>
int displaySituationAndPrompt(const char *situation, const char *option1, const char *option2) {
    printf("\n%s\n", situation);
    printf("1. %s\n", option1);
    printf("2. %s\n", option2);
...
/*int main() {
    ...
    // Subplot 8: Guardians of the Vault
    ...
    // Subplot 9: Unveiling the Treasure
    ...
    // Additional Subplot 10: The Haunted Grove
    ...
    // Additional Subplot 11: Ghostly Encounter
    ...
    // Additional Subplot 12: Guardian of the Grove
    ...
    // Additional Subplot 13: The Lost Explorer
    ...
    // Additional Subplot 14: The Forbidden Clearing
    ...
    // Additional Subplot 15: The Guardian's Test
    ...
    // Additional Subplot 16: The Trial of Courage
    ...
    // Additional Subplot 17: The Guardian's Judgment
    ...
    // Additional Subplot 18: The Final Trial
    ...
    // Additional Subplot 19: The Revelation
    ...
    // Additional Subplot 20: The Hidden Treasure
